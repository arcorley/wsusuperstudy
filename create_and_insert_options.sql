...
("ineligible_no_full_screen_reason","none",""),
...
("disinterest_reason","no_babysitter","No Babysitter"),
("disinterest_reason","pain_gone","Pain has gone away"),
("disinterest_reason","compensation","Not enough compensation"),
("disinterest_reason","lawyer","Lawyer advised them not to"),
("disinterest_reason","other","Other"),
("ppt_pain_type","none","No pain"),
...
("partner_pain_type","none","No pain"),
...
("contact_method","mail","Snail Mail"),
("contact_method","ppt_cell","Contacter Cell Phone"),
...
("ra","megan","Megan"),
("ra","emma","Emma"),
("ra","victoria","Victoria"),
("ra","hallie","Hallie"),
("outcome","spoke_both","Spoke to Both in Couple"),
("outcome","spoke_contacter","Spoke to Contacter"),
("outcome","spoke_partner","Spoke to Partner"),
("outcome","voicemail","Left Voicemail"),
("outcome","sent_email","Sent Email"),
("outcome","sent_mail","Sent Mail")
;				
